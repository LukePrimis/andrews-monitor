...
func (a *AndrewsTask) getLogin() (string, error) {
	req, err := http.NewRequest("GET", "https://get.cbord.com/brown/full/login.php", nil)
	if err != nil {
		return "", err
	}
	...
	req.Header.Set("referer", "https://get.cbord.com/brown/full/prelogin.php")
