...
func (a *AndrewsTask) getPrompt() (string, error) {
	req, err := http.NewRequest("GET", url.PathEscape(fmt.Sprintf("https://api-bf620061.duosecurity.com/prompt?sid=%s", a.Sid)), nil)
	if err != nil {
		return "", err
	}
